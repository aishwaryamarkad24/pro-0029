...
function setup() {
	...
	mango2 = new Mango(1210,250,30);
	mango3 = new Mango(1210,1900,30);
	mango4 = new Mango(1190,300,30);
	mango5 = new Mango(1230,300,30);
	mango6 = new Mango(1100,300,30);
  mango7 = new Mango(1150,190,30);
  mango8 = new Mango(1290,190,30);
  mango9 = new Mango(1250,180,30);
  mango10 = new Mango(1150,290,30);
  mango11 = new Mango(1200,250,30);
